...
function career()
{
	...
	{
		$sInsert="insert into career(title,sum,content,active,dates,meta_keyword,meta_description";
		...
		if(checkImg($file)==true)
		{
			...
			mysql_query("update career set img='$file' where id=$recent");	
		}
		if($test)
		{
	...
	{
		$sUpdate="update career set title='$title',active=$active";
	...
	<div class="row">
		<div class="col-lg-12">
			<ol class="breadcrumb">
				<li>
					<i class="fa fa-dashboard"></i> <a href="main.php?act=career">Tuyển dụng</a>
				</li>
			</ol>
		</div>
	</div>';
	...
	$str.=ad_paging($lim,$count,'main.php?act=career&',$page);
	$str.='
			</div>
		</div>
		<!-- Row -->
