...
function ad_menu()
{
	$topNav=array(
						...
						array(2,"Trụ sở công ty","station","star"),		
                       array(3,'About Us','about','signal'),
                        array(4,"Tin tức","news","fire"),
                        array(5,'Bảng giá','price','leaf'),
                        array(6,'Sản phẩm','product','book'),
                        //array(9,'Tủ bảng điện','project','bell-o'),
                        array(10,'Dịch vụ sữa chữa','serv','send'),
                        array(7,'Download','download','plus'),
                        array(8,'Liên hệ','contact','phone'),
                        
                        array(11,'Pages SEO','seo','thumbs-up'),
                        array(12,"Quản lý text","qtext","music"),
						array(13,"Quản lý người dùng","ad_user","cog")
					);
	//Submenu (parent,name,lnk)
	$subNav=array(
                    array(12,"Footer","id=1"),	
                    array(12,"Hotline","id=2"),
                    array(12,"Liên hệ","id=3")
                    //array(12,"Youtube","id=4")					
				);
	$size=sizeof($topNav);
	$act=$_GET["act"];
	$str='
